  ...
  return (
    ...
    >
      ...
      <View className="flex-1 p-6 items-center">
        ...
        {error && (
          <Text className="text-dutch-red text-sm mb-4 text-center">
            {error}
          </Text>
        )}
        ...
        {!previewGroup && (
          ...
          >
            {isLoadingPreview ? (
              ...
              <Text
                className={`text-base font-semibold ${isButtonDisabled ? (isDark ? "text-dark-text-tertiary" : "text-light-text-tertiary") : "text-white"}`}
              >
                Look Up Group
              </Text>
            )}
        ...
        {previewGroup && (
          <View
            className={`w-full rounded-xl p-6 items-center mt-4 ${isDark ? "bg-dark-card" : "bg-light-card"}`}
          >
            ...
            <Text
              className={`text-sm mb-6 ${isDark ? "text-dark-text-secondary" : "text-light-text-secondary"}`}
            >
            ...
            <Pressable className="py-2 active:opacity-70" onPress={handleReset}>
              <Text className="text-dutch-orange text-sm">
                Try Different Code
              </Text>
            </Pressable>
          </View>
